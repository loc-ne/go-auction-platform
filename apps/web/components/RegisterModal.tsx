        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center">
            ...
            <div className="relative w-full max-w-md bg-white dark:bg-[#14171d] rounded-3xl shadow-2xl overflow-hidden border border-gray-100 dark:border-white/10 p-8 transform transition-all animate-in fade-in zoom-in duration-300">
                ...
                <form className="space-y-5" onSubmit={(e) => { e.preventDefault(); onClose(); }}>
                    ...
                    <button
                        type="submit"
                        className="w-full py-4 bg-blue-600 hover:bg-blue-700 dark:bg-indigo-500 dark:hover:bg-indigo-600 text-white font-extrabold text-base rounded-xl transition-all shadow-lg shadow-blue-500/30 dark:shadow-indigo-500/25 active:scale-95 mt-6"
                    >
                        Tạo tài khoản
                    </button>
                </form>
