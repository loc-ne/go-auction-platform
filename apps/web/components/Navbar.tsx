                ...
                {!isLoggedIn ? (
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="text-right hidden sm:block">
                            <p className="text-[10px] text-gray-500 dark:text-gray-400 font-medium leading-tight">Số dư</p>
                            <p className="text-sm font-bold text-green-600 dark:text-green-400 leading-tight">12.500.000 ₫</p>
                        </div>
